	...
	<div class="container">
		<div class="row">
			<div class="baek2">
				<section>
				<div>
					<img class="baek1" src="img1.jpg" height /></a>
				</div>

				<img class="baek1" src="img1.jpg" /> </a> </section>
			</div>
			<div class="baek3">
				<section class="bb">
				<table class="spot_info_table" id="spot_info_default" width=100%>
					...
					<tr>
						<th>체류시간</th>
						<td colspan=3>1시간 이상</td>
					</tr>
					<tr>
						<th>운영시간</th>
						<td colspan=3>월~금 - 15:00 ~ 23:00<br>
