...
<script src="js/share-my-plan.js"></script>
		...
		<div class="comment-box">
			<div class="comment-form">
				...
				<form>
					...
					<br>
					<button type="submit" class="btn alt">COMMENT</button>
				</form>
			</div>
			<div>
			...
			<hr>
			<div class="footer">
				<div class="commented-item" id="comment-">
					<div class="comment-top">
						<h4>commenter-id</h4>
						<span> time : 06/17/17 3:27</span>
					</div>
					<div class="comment-body">
						<p class="comment-content">comment contents lalalal</p>
					</div>
				</div>
